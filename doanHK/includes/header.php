...
<div class="top-header">
	<div class="container">
		<ul class="tp-hd-lft wow fadeInLeft animated" data-wow-delay=".5s">
			...
			<li class="prnt"><a href="profile.php">Chỉnh Sửa Thông Tin</a></li>
				<li class="prnt"><a href="change-password.php">Đổi Mật Khẩu</a></li>
			<li class="prnt"><a href="tour-history.php">Lịch Sử/Thông Tin Vé</a></li>
	...
	<div class="container">
		<ul class="tp-hd-lft wow fadeInLeft animated" data-wow-delay=".5s">
			<li class="hm"><a href="index.php"><i class="fa fa-home"></i></a></li>
				<li class="hm"><a href="admin/index.php">Demo: Đăng Nhập Admin</a></li>
		</ul>
		<ul class="tp-hd-rgt wow fadeInRight animated" data-wow-delay=".5s"> 
			<li class="tol">Điện Thoại: 123-4568790</li>				
...
<div class="header">
	<div class="container">
		<div class="logo wow fadeInDown animated" data-wow-delay=".5s">
			<a href="index.php">Hệ Thống Quản Lý <span> Du Lịch</span></a>	
		</div>
					...
					<nav class="cl-effect-1">
						<ul class="nav navbar-nav">
							...
							<li><a href="page.php?type=aboutus">Giới Thiệu</a></li>
								<li><a href="package-list.php">Danh Sách Các Tour</a></li>
								<li><a href="page.php?type=privacy">Chính Sách</a></li>
								<li><a href="page.php?type=terms">Diều Khoản Sử Dụng</a></li>
								<li><a href="page.php?type=contact">Liên Hệ Với Chúng Tôi</a></li>
								<li><a href="enquiry.php"> Góc Thắc Mắc </a>  </li>
