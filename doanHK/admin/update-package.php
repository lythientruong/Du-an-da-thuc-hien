	...
	<body>
		<div class="page-container">
			...
			<div class="left-content">
				...
				<!--heder end here-->
				<ol class="breadcrumb">
					<li class="breadcrumb-item"><a href="./manage-packages.php">Home</a><i class="fa fa-angle-right"></i>Cập nhật Tour du lịch</li>
				</ol>
				<!--grid-->
				<div class="grid-form">
								...
								if ($query->rowCount() > 0) {
									foreach ($results as $result) {	?>
										...
										<form class="form-horizontal" name="package" method="post" enctype="multipart/form-data">
											...
											<div class="form-group">
												<label for="focusedinput" class="col-sm-2 control-label">Địa điểm đến</label>
												<div class="col-sm-8">
											...
											<div class="form-group">
												<label for="focusedinput" class="col-sm-2 control-label">Giá Tour (USD)</label>
												<div class="col-sm-8">
											...
											<div class="form-group">
												<label for="focusedinput" class="col-sm-2 control-label">Các dịch vụ đi kèm</label>
												<div class="col-sm-8">
											...
											<div class="form-group">
												<label for="focusedinput" class="col-sm-2 control-label">Ngày cập nhật cuối</label>
												<div class="col-sm-8">
