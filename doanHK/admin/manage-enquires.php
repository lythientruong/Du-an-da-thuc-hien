	...
	<body>
		<div class="page-container">
			...
			<div class="left-content">
				...
				<!--heder end here-->
				<ol class="breadcrumb">
					<li class="breadcrumb-item"><a href="./dashboard.php">Home</a><i class="fa fa-angle-right"></i>Quản lý thắc mắc</li>
				</ol>
									...
									if ($query->rowCount() > 0) {
										foreach ($results as $result) {				?>
											<tr>
												...
												<td width="100"><?php echo htmlentities($result->FullName); ?></td>
												<td width="50"><?php echo htmlentities($result->MobileNumber); ?></td>
												<td width="50"><?php echo htmlentities($result->EmailId); ?></td>
												<td width="250"><?php echo htmlentities($result->Subject); ?></a></td>
												<td width="500"><?php echo htmlentities($result->Description); ?></td>
