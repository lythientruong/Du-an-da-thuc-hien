	...
	<body>
		<div class="page-container">
			...
			<div class="left-content">
				...
				<!--heder end here-->
				<ol class="breadcrumb">
					<li class="breadcrumb-item"><a href="./dashboard.php">Home</a><i class="fa fa-angle-right"></i>Cập nhật dữ liệu trang</li>
				</ol>
				<!--grid-->
				<div class="grid-form">
							...
							<div class="tab-pane active" id="horizontal-form">
								<form class="form-horizontal" name="package" method="post" enctype="multipart/form-data">
									<div class="form-group">
										<label for="focusedinput" class="col-sm-2 control-label">Chọn Mục</label>
										<div class="col-sm-8">
											<select name="menu1" onChange="MM_jumpMenu('parent',this,0)">
												<option value="" selected="selected" class="form-control">***Chọn mục***</option>
												<option value="manage-pages.php?type=terms">Điều khoản sử dụng</option>
												<option value="manage-pages.php?type=privacy">Các chính sách</option>
												<option value="manage-pages.php?type=aboutus">Giới thiệu</option>
												<option value="manage-pages.php?type=contact">Liên hệ với chúng tôi</option>
											</select>
										</div>
									</div>
									<div class="form-group">
										<label for="focusedinput" class="col-sm-2 control-label">Mục được chọn</label>
										<div class="col-sm-8">
											<?php
